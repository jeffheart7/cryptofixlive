        ...
        function e() {
            ...
            if (!("scrollBehavior" in t.documentElement.style) || !0 === e.__forceSmoothScrollPolyfill__) {
                ...
                e.scroll = e.scrollTo = function() {
                    ...
                    void 0 !== arguments[0] && (d(arguments[0]) ? r.scrollBy.call(e, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : 0, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : 0) : g.call(e, t.body, ~~arguments[0].left + (e.scrollX || e.pageXOffset), ~~arguments[0].top + (e.scrollY || e.pageYOffset)))
    ...
    function() {
        ...
        window.kadence = {
            ...
            toggleDrawer: function(e, t) {
                ...
                else if (n.classList.add("show-drawer"), o.dataset.toggleBodyClass && (i.body.classList.toggle(o.dataset.toggleBodyClass), o.dataset.toggleBodyClass.includes("showing-popup-drawer-") && (i.body.style.setProperty("--scrollbar-offset", r + "px"), i.body.classList.add("kadence-scrollbar-fixer"))), setTimeout((function() {
            ...
            initStickyHeader: function() {
                var e = document.querySelector("#main-header .kadence-sticky-header"),
                    ...
                    a = 0,
                    l = 0;
                parseInt(kadenceConfig.breakPoints.desktop) < window.innerWidth ? (r = "desktop", e && (e.style.position = "static", l = window.kadence.getOffset(e).top, e.style.position = null)) : t && (t.style.position = "static", l = window.kadence.getOffset(t).top, t.style.position = null);
                var s, d, c, u = function(s) {
                    ...
                    if (d = kadenceConfig.breakPoints.desktop <= window.innerWidth ? e : t) {
                        ...
                        var h = d.parentNode,
                            ...
                            p = d.getAttribute("data-reveal-scroll-up"),
                        ...
                        if ((!m || s && void 0 !== s.type && "orientationchange" === s.type) && (d.setAttribute("data-start-height", d.offsetHeight), m = d.offsetHeight, h.classList.contains("site-header-upper-inner-wrap") ? (h.style.height = null, s && void 0 !== s.type && "orientationchange" === s.type ? d.classList.contains("item-is-fixed") ? setTimeout((function() {
                            ...
                            if (v) {
                                if ("true" === p)
                                    if (window.scrollY > a) var y = Math.floor(Math.floor(l) - Math.floor(c) + Math.floor(m));
                                    else y = Math.floor(l - c);
                                else y = Math.floor(l - c);
                                var b = d.querySelector(".custom-logo"),
                                    k = d.querySelector(".kadence-sticky-logo"),
                                    S = d.querySelector(".site-main-header-inner-wrap"),
                                    L = parseInt(S.getAttribute("data-start-height"));
                                if (L || (S.setAttribute("data-start-height", S.offsetHeight), L = S.offsetHeight), window.scrollY <= y) S.style.height = L + "px", S.style.minHeight = L + "px", S.style.maxHeight = L + "px", b && (b.style.maxHeight = "100%"), k && (k.style.maxHeight = "100%");
                                else if (window.scrollY > y) {
                                    var x = Math.max(v, L - (window.scrollY - (l - c)));
                                    S.style.height = x + "px", S.style.minHeight = x + "px", S.style.maxHeight = x + "px", b && (b.style.maxHeight = x + "px"), k && (k.style.maxHeight = x + "px")
                                }
                            }
                        }
                        if ("true" === p) {
            ...
            scrollToElement: function(e, t, o = "scroll") {
                ...
                var r = setInterval((function() {
                    var o = window.innerHeight + window.pageYOffset >= document.body.offsetHeight - 2;
                    (i >= 0 && Math.floor(e.getBoundingClientRect().top) - n <= 0 || i < 0 && Math.floor(e.getBoundingClientRect().top) - n >= 0 || o) && (e.tabIndex = "-1", e.focus(), e.classList.contains("kt-title-item") && e.firstElementChild.click(), t && window.history.pushState("", "", "#" + e.id), clearInterval(r))
                }), 100)
            },
